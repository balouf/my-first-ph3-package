#!/usr/bin/env python
#
# my-first-ph3-package documentation build configuration file, created by
...
version = my_first_ph3_package.__version__
# The full version, including alpha/beta/rc tags.
release = my_first_ph3_package.__version__
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/balouf/my-first-ph3-package",
...
htmlhelp_basename = 'my_first_ph3_packagedoc'
...
latex_documents = [
    (master_doc, 'my_first_ph3_package.tex',
     'My First PH3 Package Documentation',
...
man_pages = [
    (master_doc, 'my_first_ph3_package',
     'My First PH3 Package Documentation',
     [author], 1)
]
